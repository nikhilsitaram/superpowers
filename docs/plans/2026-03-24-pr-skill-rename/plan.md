...
- [x] A5: Update test fixtures and test scripts — *All test fixtures use pr-create/pr-merge instead of create-pr/merge-pr. Test descriptions and assertions updated. Tests for old enum values (create-pr, merge-pr) added as invalid_workflow rejection tests. All test scripts pass.*
