...
echo "Test 29: bash -euo pipefail scripts/validate-plan skips multiple flags"
...
assert_output_contains "bash with multiple flags resolves script" "$OUT29" "allow"
...
All tests must pass: 21 existing + 5 new safe commands + 7 interpreter resolution + 4 variable deny = 37 total.
